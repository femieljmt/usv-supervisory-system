...
# Optional navigation context is transmitted in payload_json and recorded in
# the per-session CSV, but is deliberately not required from legacy senders.
OPTIONAL_TELEMETRY_FIELDS = (
    "guided_target_lat",
    "guided_target_lon",
    "guided_target_alt",
    "guided_target_valid",
    "guided_target_updated_at",
)

CSV_TELEMETRY_FIELDS = TELEMETRY_FIELDS + OPTIONAL_TELEMETRY_FIELDS
